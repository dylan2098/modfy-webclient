      ...
      <div className="container py-2">
        <nav aria-label="breadcrumb">
          <div className="d-flex align-items-center">
            <span className="px-3 text-lg text-white font-weight-bold me-4">Modfy Ecommerce</span>
          </div>
        </nav>
                  ...
                  <a className="dropdown-item border-radius-md" href="#">
                    <div className="py-1 d-flex">
                      <div className="my-auto">
                        <img src={`https://res.cloudinary.com/dvweth7yl/image/upload/v1710921942/team-2.jpg`}  className="avatar avatar-sm  me-3 " alt="user image" />
                      </div>
            ...
            <li className="nav-item dropdown pe-2 d-flex align-items-center">
              <a href="#" className="px-0 text-white nav-link font-weight-bold">
                <div className="avatar avatar-sm position-relative">
                  <img src={`https://res.cloudinary.com/dvweth7yl/image/upload/v1710921942/team-1.jpg`} alt="profile_image" className="w-100 border-radius-md" />
                </div>
              </a>
            </li>
          </ul>
          ...
          <li className="nav-item dropdown px-3 py-3 border-radius-sm bg-slate-800 d-flex align-items-center">
            ...
            <ul className="dropdown-menu dropdown-xl" aria-labelledby="dropdownProfile" data-bs-popper="static">
              <div className="row m-3">
                {data.categories.slice(0, 2).map((category, i) => 
