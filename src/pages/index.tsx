    ...
    <div className="container mt-5">
      ...
      <div className="my-10">
        ...
        <ProductQuickview 
          ...
          rating={data.products[0].rating}
          reviews={data.products[0].reviews}
          sizes={data.products[0].sizes ? new Map(Object.entries(data.products[0].sizes)) : new Map()}
          images={data.products[0].images}
        />
      ...
      <div className="my-10">
        <ProductFeature
          ...
          full_description={data.products[0].full_description}
          featuresDetails={data.products[0].featuresDetails ? new Map(Object.entries(data.products[0].featuresDetails)) : new Map()}
        />
      </div>
      ...
      <div className="my-10">
        <ProductFeature2
          ...
          full_description={data.products[0].full_description}
          images={data.products[2].images}
          data={data.products[2].featuresDetails ? new Map(Object.entries(data.products[2].featuresDetails)) : new Map()}
        />
      </div>
      ...
      <div className="my-10">
        ...
        {
          productReviews && <ReviewSummaryChart reviews={productReviews.map(review => ({...review, productID: Number(review.productID)}))}/>
        }
      </div>
